 ...
 */
package org.xtext.vuc.mgpl.generator.cpp;
 ...
 */
class MGPLCppGenerator extends AbstractGenerator {
    
    private static val String CPP_PACKAGE_PATH = "cpp/" + PACKAGE_PATH;
    public static val String FILE_EXTENSION = ".cpp";
    public static val String HEADER_EXTENSION = ".hpp";
    private static val String INCLUDE_DIR = "include/";
    private static val String SOURCE_DIR = "src/";
    private val String packageName = "com.xtext.vuc.mgpl";
    private var String programName;
    
    override void doGenerate(Resource resource, IFileSystemAccess2 fsa, IGeneratorContext context) {
        fsa.generateFile(CPP_PACKAGE_PATH + 'Game' + FILE_EXTENSION, Game.game(packageName))
        new MGPLObjects().doGenerate(fsa, CPP_PACKAGE_PATH, packageName)
        fsa.generateFile(CPP_PACKAGE_PATH + 'Animation' + FILE_EXTENSION, Animation.animation(packageName))
        fsa.generateFile(CPP_PACKAGE_PATH + 'Util' + FILE_EXTENSION, util)
        ...
        for (prog : resource.allContents.toIterable.filter(Prog)) {
            ...
            fsa.generateFile(CPP_PACKAGE_PATH + gameName + "/" + programName + FILE_EXTENSION, prog.compile(gameName))
            fsa.generateFile(CPP_PACKAGE_PATH + gameName + "/ui/" + programName + 'UI' + FILE_EXTENSION, gameUI(prog, gameName));
        }
    }
